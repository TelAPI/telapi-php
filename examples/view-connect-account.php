...
/**
 * 
 * How to connect to TelAPI connect client and view teir/your TelAPI account details.
 * 
 * --------------------------------------------------------------------------------
 * 
...
$telapi -> getConnect() -> setCredentials(
